...
int main( int argc, char *argv[] )
{
  ...
  for (int imageIndex=1; imageIndex<numOfImages; imageIndex++) {
	  ...
	  //
	  if (imageIndex==1) {
		  std::cout<<"offset:"<<initialTransform3->GetOffset()<<std::endl;
	      ...
	      initializer->SetMovingImage( movingImage );
		  initializer->InitializeTransform();
		  outputTransform3->SetCenter(movingCenter);
	  ...
	  if (imageIndex==1) {
	      ...
	      initializer->SetMovingImage( movingImage );
		  initializer->InitializeTransform();
		  outputTransform2->SetCenter(movingCenter);
	  ...
	  if (imageIndex==1) {
	      ...
	      initializer->SetMovingImage( movingImage );
		  initializer->InitializeTransform();
		  outputTransform1->SetCenter(movingCenter);
