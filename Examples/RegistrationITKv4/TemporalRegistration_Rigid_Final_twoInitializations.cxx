...
int main( int argc, char *argv[] )
{
  ...
  for (int imageIndex=1; imageIndex<numOfImages; imageIndex++) {
	  ...
	  double metricValue1_initializedZeros, metricValue2_initializedZeros, metricValue3_initializedZeros;
	  ...
	  TransformInitializerType::Pointer zerosInitializer = TransformInitializerType::New();
	  ...
	  if (imageIndex==1) {
		  ...
		  std::cout << "initialTransform3: " << initialTransform3->GetParameters() << std::endl;
	  ...
	  if (imageIndex!=1) {
		  ...
		  zerosInitializer->SetTransform(   initialTransform3 );
		  zerosInitializer->SetFixedImage(  fixedImage );
		  zerosInitializer->SetMovingImage( movingImage );
		  zerosInitializer->MomentsOn();
		  zerosInitializer->InitializeTransform();
		  ...
		  metricValue3_initializedZeros = optimizer->GetCurrentMetricValue();
		  outfile_metric << metricValue3_initializedZeros << std::endl;
	  ...
	  if (imageIndex!=1) {
		  ...
		  zerosInitializer->SetTransform(   initialTransform2 );
		  zerosInitializer->SetFixedImage(  fixedImage );
		  zerosInitializer->SetMovingImage( movingImage );
		  zerosInitializer->MomentsOn();
		  zerosInitializer->InitializeTransform();
		  ...
		  std::cout << "initialTransform2: " << initialTransform2->GetParameters() << std::endl;
		  ...
		  metricValue2_initializedZeros = optimizer->GetCurrentMetricValue();
		  outfile_metric << metricValue2_initializedZeros << std::endl;
	  ...
	  if (imageIndex!=1) {
		  ...
		  zerosInitializer->SetTransform(   initialTransform1 );
		  zerosInitializer->SetFixedImage(  fixedImage );
		  zerosInitializer->SetMovingImage( movingImage );
		  zerosInitializer->MomentsOn();
		  zerosInitializer->InitializeTransform();
		  ...
		  std::cout << "initialTransform1: " << initialTransform1->GetParameters() << std::endl;
		  ...
		  metricValue1_initializedZeros = optimizer->GetCurrentMetricValue();
		  outfile_metric << metricValue1_initializedZeros << std::endl;
	  ...
	  if (imageIndex==1) {
		  ...
		  if (metricValue1<=metricValue2&&metricValue1<=metricValue3&&metricValue1<=metricValue1_initializedZeros&&metricValue1<=metricValue2_initializedZeros&&metricValue1<=metricValue3_initializedZeros) {
			  outputTransform = outputTransform1->Clone();
		  }
		  if (metricValue2<=metricValue1&&metricValue2<=metricValue3&&metricValue2<=metricValue1_initializedZeros&&metricValue2<=metricValue2_initializedZeros&&metricValue2<=metricValue3_initializedZeros) {
			  outputTransform = outputTransform2->Clone();
		  }
		  if (metricValue3<=metricValue1&&metricValue3<=metricValue2&&metricValue3<=metricValue1_initializedZeros&&metricValue3<=metricValue2_initializedZeros&&metricValue3<=metricValue3_initializedZeros) {
			  outputTransform = outputTransform3->Clone();
		  }
		  if (metricValue1_initializedZeros<=metricValue2_initializedZeros&&metricValue1_initializedZeros<=metricValue3_initializedZeros&&metricValue1_initializedZeros<=metricValue1&&metricValue1_initializedZeros<=metricValue2&&metricValue1_initializedZeros<=metricValue3) {
			  outputTransform = initialTransform1->Clone();
		  }
		  if (metricValue2_initializedZeros<=metricValue1_initializedZeros&&metricValue2_initializedZeros<=metricValue3_initializedZeros&&metricValue2_initializedZeros<=metricValue1&&metricValue2_initializedZeros<=metricValue2&&metricValue2_initializedZeros<=metricValue3) {
			  outputTransform = initialTransform2->Clone();
		  }
		  if (metricValue3_initializedZeros<=metricValue1_initializedZeros&&metricValue3_initializedZeros<=metricValue2_initializedZeros&&metricValue3_initializedZeros<=metricValue1&&metricValue3_initializedZeros<=metricValue2&&metricValue3_initializedZeros<=metricValue3) {
			  outputTransform = initialTransform3->Clone();
		  }
	  }
