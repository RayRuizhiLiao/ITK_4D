 ...
 *
 *=========================================================================*/
#ifndef itkSignedHardLimitTransferFunction_h
#define itkSignedHardLimitTransferFunction_h
...
class ITK_TEMPLATE_EXPORT SignedHardLimitTransferFunction : public TransferFunctionBase<ScalarType>
{
public:
