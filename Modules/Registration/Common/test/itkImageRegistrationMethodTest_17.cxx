 ...
 *
 *  The image value is shifted left by 24000.0 such that all the image value
 *  has a negative value. Without the fix of initial ImageTrueMax value in
 *  itkMattesMutualInformationImageToImageMetric.hxx, this test will fail
 *  because the image values all will be in the leftmost histogram bin.
 *
