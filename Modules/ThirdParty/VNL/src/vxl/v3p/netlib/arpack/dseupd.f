...
c                call dvout(logfil, 1, thres1, ndigit,
c     &          '_seupd: Threshold eigenvalue used for re-ordering')
c             end if
c
...
c
             if (msglvl .gt. 2) then
                kv(1) = thres1
                kv(2) = thres2
c                call dvout(logfil, 2, kv, ndigit,
c     &          '_seupd: Threshold eigenvalues used for re-ordering')
             end if
c
         end if
c
...
c
c         if (msglvl .gt. 2) then
c             call ivout(logfil, 1, ktrord, ndigit,
