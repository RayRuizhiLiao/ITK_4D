...
#include <float.h>
// Timing features disabled #include <sys/time.h>
...
static doublereal epsilon1()
{
  //Fortran code used intrinsic epsilon(1.) function
  //which is the same as DBL_EPSILON.
  return DBL_EPSILON;
} /* dpmeps_ */
...
/* Subroutine */ int setulb_(integer *n, integer *m, doublereal *x,
        ...
        *g, doublereal *factr, doublereal *pgtol, doublereal *wa, integer *
        ...
        integer *isave, doublereal *dsave /*f2c autogenerated , ftnlen task_len, ftnlen csave_len */)
{
        ...
        integer *head, integer *info)
{
    ...
    /* Subroutine */ int lbfgsb_local_dpofa_(doublereal *, integer *, integer *,
...
/*                          with L' stored in the upper triangle of wn. */
    lbfgsb_local_dpofa_(&wn[wn_offset], &m2, col, info);
    if (*info != 0) {
        *info = -1;
        return 0;
    }
...
/*     Cholesky factorization of (2,2) block of wn. */
    lbfgsb_local_dpofa_(&wn[*col + 1 + (*col + 1) * wn_dim1], &m2, col, info);
    if (*info != 0) {
        *info = -2;
        return 0;
    }
...
/*        J' stored in the upper triangle of wt. */
    lbfgsb_local_dpofa_(&wt[wt_offset], m, col, info);
    if (*info != 0) {
        *info = -3;
    }
    return 0;
...
/* Table of constant values */
/* Subroutine */ int lbfgsb_local_dpofa_(doublereal *a, integer *lda, integer *n, integer *
        info)
{
    /* System generated locals */
